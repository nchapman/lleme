...
// GetOptions returns a shallow copy of the preset's options.
...
// MergeServerOptions builds a server options map layering preset options
// under the caller-supplied personaOpts (which should already be resolved
// via Persona.GetServerOptions). Persona keys win on conflict. Returns nil
