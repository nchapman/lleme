  ...
  lleme pull unsloth/Llama-3.2-1B-Instruct-GGUF:Q8_0      # Download specific quant`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if len(quants) == 0 {
			...
			fmt.Println("lleme runs GGUF models via llama.cpp. If this is an MLX or PyTorch")
			fmt.Println("repository, look for a GGUF build instead (e.g. a bartowski/* or unsloth/* release).")
			ui.ExitFunc(1)
			return
		}
